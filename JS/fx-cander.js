var createCalendarWidget = function(a) {
        ...
        this.create = function() {
            ...
            else if (window.attachEvent) { window.attachEvent("onload", a); var e = document.createElement("div"); try { var h = null === window.frameElement } catch (l) {}
    ...
    economicCalendarEvent = function(a) { createCalendarWidget.apply(this, arguments); var b = this;
        ...
        this.createSrc = function() { var a = "";
            b.mode && (a += "?displayMode=" + b.mode);
            b.showTitle && (a += (b.mode ? "&" : "?") + "showTitle=1"); return "https://www.tradays.com/" + b.lang + "/economic-calendar/widget/event/" + b.id + a };
        this.create() };